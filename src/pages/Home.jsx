    ...
    <div className='d-flex justify-content-evenly align-items-center mt-3 w-100'>
      ...
      <Card.Body>
        <Card.Text className='d-flex justify-content-center align-items-center flex-column'>
          <img width={'60px'} height={'60px'} className='rounded-circle img-fluid' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkbnosndS-wCLsNzlDfMdYpmwhOEJN_vqmrQ&s" alt="" />
